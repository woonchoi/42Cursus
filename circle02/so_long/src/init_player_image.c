...
/*   Updated: 2022/02/25 13:16:08 by woonchoi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_player_south(t_info *info)
{
	...
	info->asset.baba_end[0] = ft_xpm_to_img(info, "win_0_1.xpm", IMG_D);
	info->asset.baba_end[1] = ft_xpm_to_img(info, "win_0_2.xpm", IMG_D);
	info->asset.baba_end[2] = ft_xpm_to_img(info, "win_0_3.xpm", IMG_D);
}
